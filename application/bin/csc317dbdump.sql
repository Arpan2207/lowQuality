...
CREATE TABLE `comments` (
  ...
  `fk_userId` int unsigned DEFAULT NULL,
  ...
  CONSTRAINT `author_id` FOREIGN KEY (`fk_userId`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
-- Dump completed on 2023-10-05 19:53:05
